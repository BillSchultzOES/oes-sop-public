...
What we call Lin adjustment produces equivalent treatment effect estimates to a different procedure that has been called things like the "oaxaca-blinder estimator" [@guo2023generalized], "full regression adjustment" [@negi2021revisiting], or "G-computation" [@snowden2011implementation; @greifer2023estimating]. In a simple two-arm randomized trial, it proceeds as follows:^[This is the standard approach. Tnstead of imputing all potential outcomes, in principle you could also impute only the missing potential outcomes. In some situations this could be preferable, though generally the standard approach will be more efficient.]
