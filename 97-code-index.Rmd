...
- (4.1 - 4.2) Advantages of urn draw randomization in terms of precise control over the number treated; 2+ groups
...
- (4.8.4) Omnibus tests (asymptotic inference and randomization inference)
...
- (5.2.1) Estimating in multiple arm trials

Multiple testing adjustment

- (5.2.1 - 5.2.2) Some methods for multiple treatment arms and/or multiple outcomes, including randomization inference simulations

Covariate adjustment

- (5.3.2 - 5.3.3) Lin (2013) adjustment and Rosenbaum (2002) adjustment as alternatives to (standard) linear, additive adjustment for covariates
