...
The corresponding author and current maintainer is Bill Schultz. Feel free to just reach out to him with questions: william.schultz@gsa.gov. Since joining this project, Bill has helped to update the backend code, text, and example code throughout, including all of the Stata examples.
