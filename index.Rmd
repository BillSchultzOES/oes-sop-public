---
title: OES Methodological Standard Operating Procedures
...
The corresponding author and current maintainer is Bill Schultz. Feel free to just reach out to him with questions: william.schultz@gsa.gov. Since taking responsibility for this project Bill has updated the back-end code, helped to rewrite the text, and revised code examples throughout. This includes drafting new sections of this document on balance testing and multiple testing corrections, and also coming up with all of the parallel Stata examples.
