...
*First*, this document educates new team members about the decisions past team members have made regarding the design and analysis of the studies fielded so far. It also serves as a place to record decisions for [our
...
Of course, many members of our team also use Stata, SAS, SPSS, Python (either in addition to or instead of R). To help improve accessibility to Stata users in particular, much of the R code in this SOP is now accompanied by code show how the same task or something similar could be accomplished in Stata. However, this is for illustrative purposes, and all reported results and all figures are generated based only on the R code.
