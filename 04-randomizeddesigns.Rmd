...
For these reasons, project teams may reasonably conclude that the benefits of blocking are not always worth its downsides. Often, adjusting for prognostic (i.e., correlated with $Y$) covariates during the analysis stage provides sufficient improvements in precision.
